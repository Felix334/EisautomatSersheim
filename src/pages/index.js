...
let ice_ = [Kaesekuchen, BunterKleks, Cocoloco, BananaSplit, Haselnuss, Schokolade, Stratcciatella, Jogurt, JogurtHimbere, JogurtCassis, Pistazie, JogurtErdbeere, SaltetKaramell, Vanille, Kaffe, Kokustraum, SchokoKeks, MangoPassionsFruchtSorbet, ErdbeerSorbet, ZitronenSorbet, JogurtHolunder, SchokoVegan, HundeEis];
      ...
      {showBanner && (
        <div id={"CookieBanner"} style={styles.cookieConsentBanner}>
          ...
          <div style={styles.buttonWrapper}>
            ...
            <button onClick={handleDeclineCookies} style={styles.declineButton}>
              Cookies ablehnen
            </button>
          </div>
        </div>
...
function EisKlein({ searchQuery }) {
  const filteredIceCreams = ice_.filter((ice) => ice.name.toLowerCase().includes(searchQuery.toLowerCase()));
  ...
  return (
    ...
    <main className="flex flex-col items-center justify-between p-4">
      ...
      <div style={styles.headerwrapper}>
        <script async src="https://pagead2.googlesyndication.com/pagead/js/nonpersonalized-adsbygoogle.js" crossOrigin="anonymous"></script>
